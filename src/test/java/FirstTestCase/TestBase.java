...
public class TestBase {
    ...
    private static final String FIRST_URL = "https://katco.ru/";
    private static final String SECOND_URL = "https://katsoekb.ru/";
    ...
    public void setUp() {
        ...
        capabilities.setCapability("videoName", "KatsoTestCaseForFirstSendOrder.mp4");
        capabilities.setCapability("name", "KatsoTestCaseForFirstSendOrder");
    ...
    public void pickRandCards() {
        List<SelenideElement> clickRandomCards = elements(By.xpath("//div[contains(@class, \"productBox\") and not (contains(@class, \"action-wrapper\"))]//div[@class = \"summary-bottom\"]/a[contains(@class, \"add-cart\")]"));
        ...
        SelenideElement blackMFP = $x("//div[@class = \"cart-notification-message\"]");
        System.out.println("-----!Before IF!-----");
        if (mfpContent.isDisplayed()) {
    ...
    public void goBasket() {
        ...
        System.out.println("-----!Start Go basket!-----");
        $x("//a[contains(@class, \"price-float\") and (contains(@href, \"/order\"))]").click();
        System.out.println("-----!End Go basket!-----");
    }
